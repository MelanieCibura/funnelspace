const PRODUCTS = [
  ...
  { img: 'email.png',             name: 'E-Mail-Marketing',  desc: 'Newsletter, Automationen und Sequenzen. Zustellraten wie bei den Großen.' },
  ...
  <section className="section" id="produkt">
    <div className="section__inner">
      <div className="section__head">
        ...
        <h2>Fünf Tools. Ein Login. Eine Rechnung.</h2>
